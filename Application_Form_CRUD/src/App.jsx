...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(values)
    alert("Form submit")
    resetFunc("Pass arguments by props after submit and reset");
  }


  const resetFunc = (abc) => {
    setValues({ firstname: '', lastname: '', email: '', contact: '', subject: '', resume: '', url: '', about: abc });
  }
  console.log(values)
  return (
    <>
      <div className='container'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" placeholder='Enter First Name' name='firstname' onChange={handleChange} required value={values.firstname} />
          ...
          <textarea name="about" id="about" cols="30" rows="10" placeholder='Enter Descrption' value={values.about} onChange={(e) => handleChange(e)}></textarea>
